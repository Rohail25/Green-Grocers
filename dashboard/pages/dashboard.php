...
<div class="space-y-6">
    ...
    <div class="bg-white shadow rounded-lg p-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="/green-php/dashboard/pages/featured-products.php" class="flex items-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors">
            ...
            <a href="/green-php/dashboard/pages/products.php" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
            ...
            <a href="/green-php/dashboard/pages/orders.php" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                ...
                <tbody class="divide-y divide-gray-200">
                    <?php foreach ($recentOrders as $order): ?>
                        <tr class="hover:bg-gray-50">
                            <td class="py-2 px-3"><?php echo htmlspecialchars($order['order_number']); ?></td>
                            <td class="py-2 px-3"><?php echo htmlspecialchars(($order['first_name'] ?? '') . ' ' . ($order['last_name'] ?? '')); ?></td>
                            ...
                            <td class="py-2 px-3">$<?php echo number_format($order['total_amount'], 2); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
