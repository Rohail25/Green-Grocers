...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <a href="add-package.php" class="flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition">
            ...
            <tbody class="bg-white divide-y">
                <?php foreach ($packages as $pkg): ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2"><?php echo htmlspecialchars($pkg['package_day'] ?? 'N/A'); ?></td>
                        <td class="px-4 py-2">$<?php echo number_format($pkg['retail_price'], 2); ?></td>
                        <td class="px-4 py-2"><?php echo $pkg['is_featured'] ? 'Active' : 'Inactive'; ?></td>
                        <td class="px-4 py-2 space-x-2">
                            <a href="edit-package.php?id=<?php echo $pkg['id']; ?>" class="text-blue-600 hover:underline">Edit</a>
