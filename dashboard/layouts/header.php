...
<div class="flex h-screen bg-gray-50">
    ...
    <aside class="w-64 bg-white border-r shadow-sm flex flex-col">
        ...
        <nav class="flex-1 px-2 mt-4 space-y-1">
            <a href="/green-php/dashboard/pages/dashboard.php" class="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-lg font-semibold transition <?php echo $active === 'Dashboard' ? 'text-green-600 border border-gray-200 bg-green-50' : 'text-gray-700 hover:bg-gray-100'; ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                <span>Dashboard</span>
            </a>
            <a href="/green-php/dashboard/pages/products.php" class="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-lg font-semibold transition <?php echo $active === 'Products' ? 'text-green-600 border border-gray-200 bg-green-50' : 'text-gray-700 hover:bg-gray-100'; ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                <span>Products</span>
            </a>
            <a href="/green-php/dashboard/pages/packages.php" class="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-lg font-semibold transition <?php echo $active === 'Packages' ? 'text-green-600 border border-gray-200 bg-green-50' : 'text-gray-700 hover:bg-gray-100'; ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>
                <span>Daily Packages</span>
            </a>
            <a href="/green-php/dashboard/pages/orders.php" class="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-lg font-semibold transition <?php echo $active === 'Orders' ? 'text-green-600 border border-gray-200 bg-green-50' : 'text-gray-700 hover:bg-gray-100'; ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                <span>Orders</span>
            </a>
            <a href="/green-php/dashboard/pages/featured-products.php" class="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-lg font-semibold transition <?php echo $active === 'Featured Products' ? 'text-green-600 border border-gray-200 bg-green-50' : 'text-gray-700 hover:bg-gray-100'; ?>">
